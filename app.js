const phaseData = {
  before: {
    ...
    dimensionMap: [
      { name: "课件", focus: "预习仅保留闪卡互动，不提前开放完整课件。", kpi: "预习物料使用率 >= 90%", measure: "预习行为日志" },
      { name: "老师", focus: "老师课前必须查看学情标签与授课亮点模板。", kpi: "课前信息读取率 >= 95%", measure: "外教工作台日志" },
      { name: "学生链路", focus: "家长/学生定级测试数据拆分，访谈信息结构化沉淀。", kpi: "定级问卷覆盖率 >= 95%", measure: "销售填报看板" },
      { name: "课前提醒", focus: "家长/学生 + 老师双通道分层触达，缺席后补触达闭环。", kpi: "外呼触达率 >= 95%", measure: "触达链路日志" }
    ],
    summary: {
      owner: "产品负责人",
      due: "W1",
    ...
    actions: {
      产品: {
        ...
        due: "W1",
        threshold: "外呼触达率 >= 95%",
        items: ["上线品牌 AI 智能分层外呼提醒（家长/学生 + 老师双通道、分时段触达）。", "缺课后 1 小时内 AI 自动补触达并同步销售。", "定级测试 App 埋点轻量化：按家长/学生双人群拆分设计。"]
      },
      教研: {
        priority: "P0",
        owner: "教研负责人",
        ...
        items: ["预习仅提供闪卡互动游戏，不开放完整课件。", "输出标准化中英双语课堂资源：课堂用语 + 操作动画。（竞品已标配）"]
      },
      教学: {
        priority: "P0",
        owner: "教学负责人",
        ...
        items: ["建立试听老师分层规则（高阶/基础）并匹配学员意向等级。", "输出课前备课模板，明确每节试听课 2-3 个亮点环节预案。", "教学负责人必须培训老师课前查看学生信息与素材后再上课。"]
      },
      销售: {
        priority: "P0",
        owner: "销售负责人",
        due: "W1",
        threshold: "建联完成率 >= 95%",
        items: ["建立家长建联话术：先明确家长要解决的问题，再匹配课程方案。", "销售执行学科输出的定级测试 App 基本操作指引，确保首通可落地。", "销售需要把学情信息与定级结果直通外教工作台。", "销售需及时同步家长期待与风险点到 OPS，回传外教课前准备。"]
      },
      学科: {
        priority: "P0",
        owner: "学科负责人",
  ...
  after: {
    ...
    dimensionMap: [
      { name: "课件", focus: "报告模板承接课堂训练重点与错因，并映射课堂亮点。", kpi: "报告完整率 >= 95%", measure: "报告生成日志" },
      { name: "老师", focus: "课后 5 分钟内完成课程评价回收（结构化）。", kpi: "5 分钟评价回收率 >= 90%", measure: "课后评价回收日志" },
      { name: "学生链路", focus: "转化/未转化分层沉淀，未转化学生分析记录可追踪。", kpi: "未转化原因记录率 >= 95%", measure: "未转化复盘表" },
      { name: "课前提醒", focus: "二次电话规划携带完整报告，明确下一步解决方案。", kpi: "二次电话完成率 >= 90%", measure: "二次跟进台账" }
    ],
    summary: {
      owner: "销售负责人",
      due: "W2",
    ...
    actions: {
      ...
      教学: {
        ...
        items: ["下课 5 分钟内老师完成课程评价回收，并由培训明确执行步骤。", "老师评价需绑定本节 2-3 亮点与学生表现。", "评价结果同步销售与学科看板。"]
      },
      销售: {
        priority: "P0",
        owner: "销售负责人",
        ...
        items: ["课后 5 分钟向家长发起即时反馈问询，记录本节感知与疑虑。", "二次电话携带报告给建议：回答“孩子课堂具体表现 + 下一步怎么解决问题”。", "建立未转化学生分析记录（按老师层级/课堂亮点/家长诉求拆解）。", "每节试听课推动家长点击“强反馈按钮”，完成课程评分、老师评分与建议回收。"]
      },
      学科: {
        priority: "P0",
        owner: "学科负责人",
